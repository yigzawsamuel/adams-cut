    ...
    <section id="kontakt" className="py-[clamp(5rem,10vw,7rem)]"
      ...
      <div className="max-w-salon mx-auto px-[clamp(1.5rem,5vw,4rem)]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-start">
              ...
              {[
                {
                  ...
                  label: 'Adresse',
                  content: <a href={salonConfig.adresse.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="hover:text-[#B87333] transition-colors" style={{ color: '#8A7E72' }}>{salonConfig.adresse.strasse}<br/>{salonConfig.adresse.plz} {salonConfig.adresse.stadt}</a>,
                },
                {
                  ...
                  label: 'Telefon',
                  content: <a href={salonConfig.kontakt.telefonHref} className="hover:text-[#B87333] transition-colors" style={{ color: '#8A7E72' }}>{salonConfig.kontakt.telefon}</a>,
                },
                {
                  ...
                  label: 'Instagram',
                  content: <a href={salonConfig.kontakt.instagramUrl} target="_blank" rel="noopener noreferrer" className="hover:text-[#B87333] transition-colors" style={{ color: '#8A7E72' }}>{salonConfig.kontakt.instagram}</a>,
                },
                ...
                <div key={label} className="flex items-start gap-3.5">
                  ...
                  <div>
                    <div className="text-[0.85rem] font-medium mb-0.5" style={{ color: '#EDE8E1' }}>{label}</div>
          ...
          {/* Öffnungszeiten */}
          <Reveal delay={150}>
            <h3 className="font-display font-bold text-[1.35rem] mb-6" style={{ color: '#EDE8E1' }}>
              Öffnungszeiten
            </h3>
                ...
                return (
                  ...
                  >
                    <span className="text-[0.85rem] flex items-center gap-2.5"
                      style={{ color: isToday ? '#B87333' : '#8A7E72' }}>
                      {row.tag}
                      {isToday && (
                    ...
                    <span className="text-[0.85rem] font-medium"
                      style={{ color: isToday ? '#B87333' : row.geschlossen ? 'rgba(237,232,225,0.2)' : '#EDE8E1' }}>
                      {row.zeit}
                    </span>
                  </li>
                )
